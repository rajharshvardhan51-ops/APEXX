      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 z-50 w-[82vw] max-w-[320px] bg-[#060608] border-r border-[#1E1E26] text-[#FFFFFF] flex flex-col justify-between select-none md:hidden overflow-hidden"
          >
            {/* Drawer Header */}
            <div className="p-4 border-b border-[#1E1E26] flex items-center justify-between bg-[#08080A]">
              ...
              <button
                onClick={onClose}
                className="w-8 h-8 rounded-md bg-[#121217] hover:bg-[#FFFFFF] text-[#8E8E93] hover:text-[#000000] border border-[#1E1E26] flex items-center justify-center transition-colors"
            ...
            <div className="px-4 py-2 bg-[#000000] border-b border-[#1E1E26] flex items-center justify-between text-[10px] font-mono">
            ...
            {/* Navigation List */}
            <nav className="flex-1 p-3 space-y-1.5 overflow-y-auto font-mono">
              {menuItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    onClick={onClose}
                    className={`flex items-center gap-3 px-3 py-3 rounded-lg text-xs transition-all duration-200 ${
                      isActive
            ...
            <div className="p-4 border-t border-[#1E1E26] bg-[#08080A] space-y-2 pb-safe">
              {onOpenInstall && (
                <button
                  onClick={() => {
                    onClose();
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg bg-[#FFFFFF] hover:bg-[#E4E4E7] text-[#000000] font-mono text-xs font-bold transition-all shadow-[0_0_12px_rgba(255,255,255,0.2)]"
                >
