        ...
        <div className="flex items-center gap-1.5 font-mono text-[11px] overflow-x-auto pb-1 sm:pb-0">
          ...
          {['ALL', 'DEV', 'FITNESS', 'ACADEMICS', 'MIND'].map((cat) => (
            <button
              ...
              className={`px-2.5 py-1 rounded text-[10px] font-bold uppercase font-mono transition-all duration-150 border ${
              ...
              >
                ...
                <div className="flex items-start sm:items-center gap-3">
                  ...
                  <button
                    ...
                    className={`w-5 h-5 rounded-sm border transition-all duration-150 flex items-center justify-center shrink-0 mt-0.5 sm:mt-0 ${
                      quest.completed
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 sm:pt-0 border-t sm:border-t-0 border-[#1E1E26]/50">
                  ...
                  {!quest.completed && (
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1 rounded bg-[#000000] hover:bg-[#FFFFFF] text-[#FFFFFF] hover:text-[#000000] border border-[#1E1E26] hover:border-[#FFFFFF] font-mono text-[11px] font-bold transition-all duration-150 shrink-0"
                    >
